...
<body class="bg-light text-left">
	...
	<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #292b2c;">
		<a class="navbar-brand" style="color: teal; font-weight: bold;" href="#"><img src="images/iniesta-logo.jpg" alt="iniesta-logo" style="border-radius: 5px; margin-bottom: -10px;"> Client Dashboard <br> <span style="font-size: 15px; margin-left: 80px;">( INIESTA )</span> </a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item dropdown">
					<a href="" class="nav-link" style="padding-top: 20px; color: white;">My Profile &nbsp; <img class="feed-profile-logo" src="images/feed-profile-logo.jpg" alt=""></a>
				</li>
				...
				<li class="nav-item dropdown">
					<a href="contact/contact.php" class="nav-link" style="padding-top: 20px; color: white;"> Contact Us </a>
				</li>
				...
				<li class="nav-item dropdown">
					<a class="nav-link" href="logout.php" style="padding-top: 20px; color: white;" data-toggle="modal" data-target="#myModal"> Logout </a>
				</li>
				<!-- The Modal -->
				...
				<div class="card text-center card-client-dashboard">
					...
					<div class="card-body" style="padding: 10% 5%;">
						...
						<div class="alert alert-warning">
							<strong> Note! </strong> It has been seen that You haven't Hired Anyone Yet!
						</div>
						<?php } ?>
