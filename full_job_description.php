...
<div class="alert alert-danger" style="width: 50%; margin-left: 25%;">
			<strong > Note! </strong><span style="font-size:15px;"> Once,You Applied will be redirect to previous page. Although! can find the applied jobs in History.</span> 
		</div>
	<div class="container bg-light mt-4">
		...
		<p style="color: green; text-align: center; "> Applied Succesfully </p>
		<br>
