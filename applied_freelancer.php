...
<body class="bg-light text-left">
	...
	<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #292b2c;">
		<a class="navbar-brand" style="color: teal; font-weight: bold;" href="my-hires.php"><img src="images/iniesta-logo.jpg" alt="iniesta-logo" style="border-radius: 5px;"> INIESTA Freelancing</a>
		...
		<div class="jumbotron tab-content profile-tab" id="myTab1Content" style="border:2px solid grey;shadow:2px 3px;background:white;">
			...
			?>
				<div id="content" class="Data border p-2" style="line-height: 1.8;;">
					...
					<div class="row">
						<div class="col-sm-12"> <a href="my-hired.php?hired_c_token=<?php echo base64_encode($client_token_hire).'&hired_u_token='.base64_encode($user_token_hire); ?>" 
