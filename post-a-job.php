...
if(isset($_POST['submit']))
{
	...
	$query .= "VALUES({$client_id}, '{$firstname}', '{$company_name}', '{$project_name}',  '{$select}', '{$description}', '{$details}', '{$skills_required}', '{$job_vacancy}', '{$Date}', '{$pay}', '{$experience}', '{$project_time}', '{$token}' )";
	...
	<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #292b2c;">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown">
					<a class="nav-link" href="" style="padding-top: 20px; color: white;">Messages</a>
				</li>
				...
				<li class="nav-item dropdown">
					<a class="nav-link" href="logout.php" style="padding-top: 20px; color: yellow;"> Logout </a>
				</li>
			</ul>
		</div>
	</nav>
			...
			<div class="tab-pane fade show active col-md-6" id="Title" role="tabpanel" aria-labelledby="expertise-tab">
				<div class="card" style="text-align: left;">
					...
					<div class="card-body">
						...
						<input type="text" class="form-control" placeholder="Enter name here" name="project_name">
						<p class="card-text"><b>Name of the Company</b></p>
						<input type="text" class="form-control" placeholder="Enter Comapny name" name="company_name">
						<br>
			...
			<div class="tab-pane fade col-md-6" id="Description" role="tabpanel" aria-labelledby="expertise-level-tab">
				<div class="card" style="text-align: left;">
					...
					<div class="card-body">
						...
						<textarea name="job_description" id="" cols="30" rows="5" class="form-control"></textarea>
						<div style="text-align: right; padding-top: 3%;">
			...
			<div class="tab-pane fade col-md-6" id="Expertize" role="tabpanel" aria-labelledby="employment-tab">
				<div class="card" style="text-align: left;">
					...
					<div class="card-body">
						...
						<textarea name="skills_required" id="" cols="30" rows="5" class="form-control"></textarea>
						<div style="text-align: right; padding-top: 3%;">
