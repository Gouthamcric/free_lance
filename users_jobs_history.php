				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-body">
							...
							echo "<button class='btn btn-success'>$job_status</button> <a href='index_2.php' class='btn btn-info'>Chat</a>"; } else { echo "<button class='btn btn-primary' disabled>Already Applied</button>"; }?> 
							</a>
						</div>
					</div>
				</div>
