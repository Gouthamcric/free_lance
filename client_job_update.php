...
if(isset($_POST['update']))
{
	...
	job_description = '{$description}', job_details = '{$c_details}', job_expertise_skills = '{$skills_required}', job_vacanies = '{$job_vacancy}', date = now() ,
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item dropdown">
					<a href="client-dashboard.php" class="nav-link" style="padding-top: 20px;">Back To Dashboard </a>
				</li>
				<li class="nav-item dropdown trainings">
					<a href="" class="nav-link" style="padding-top: 20px;">Report</a>
				</li>
				<li class="nav-item dropdown">
					<a class="nav-link" href="" style="padding-top: 20px;">Messages</a>
				</li>
